...
public class P1_CajeroSC implements Runnable {
	private double dinero;
	private P1_CuentaBancariaSC cuenta;
	...
	P1_CajeroSC(P1_CuentaBancariaSC cuenta,double dinero) {
		this.dinero=dinero;
		this.cuenta=cuenta;
	}
	...
	public static void main(String args []) {
		...
		{
			ti[i]=new Thread(new P1_CajeroSC(c,1.));	//cada P1_CajeroSC mete 1 euro
			tr[i]=new Thread(new P1_CajeroSC(c,-1.));	//cada P1_CajeroSC saca 1 euro
			ti[i].start();
			tr[i].start();
		}
